...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <form action="product_edit.php?id=<?= $id; ?>" method="POST" class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
        ...
        <div>
            ...
            <textarea name="description" rows="3" class="resize-none mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-indigo-500"><?= htmlspecialchars($product['description']); ?></textarea>
        </div>
